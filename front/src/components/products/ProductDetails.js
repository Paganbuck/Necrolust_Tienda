          ...
          <div className='row d-flex justify-content-around'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
              ...
              <div className='stockCounter d-inline'>
                ...
                <input
                  type='number'
                  className='form-control count d-line'
              ...
              <button
                type='button'
                id='carrito_btn'
                className='btn btn_primary d-line ml-4'
              ...
              <hr />
              <h4 className='mt-2'>Descripciòn</h4>
              ...
              {/*Mensaje emergente para dejar opinión y calificación*/}
                      ...
                      <div className='modal-dialog' role='document'>
                        <div className='modal-content'>
                          ...
                          <div className='modal-body'>
                            <ul className='stars'>
                              <li className='stat'><i className='fa fa-star'></i></li>
                              <li className='stat'><i className='fa fa-star'></i></li>
                              <li className='stat'><i className='fa fa-star'></i></li>
                              <li className='stat'><i className='fa fa-star'></i></li>
                              <li className='stat'><i className='fa fa-star'></i></li>
